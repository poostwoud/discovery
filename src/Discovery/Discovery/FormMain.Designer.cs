namespace Discovery
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
			...
			// 
			this.SplitContainerBrowsers2.Panel2.Controls.Add(this.WebBrowserDisplay);
			...
			// WebBrowserDisplay
			// 
			this.WebBrowserDisplay.Dock = System.Windows.Forms.DockStyle.Fill;
			this.WebBrowserDisplay.Location = new System.Drawing.Point(5, 28);
